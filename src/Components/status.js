...
class Status extends Component {
    ...
    report(e) {
        if (this.state.choice == 'fund') {
            ...
            let t = [];
            for (j = 0; j < 19; j++) {
                t[j] = this.state.response.ap[j].fund.disbursed;
            }
            var data = [];
            for (j = 0; j < 19; j++) {
                data[j + 1] = t[j];
        ...
        if(this.state.choice == 'startup') {
            console.log(this.state.nos)
            let j = 0;
            let t = [];
            for (j = 0; j < 19; j++) {
                t[j] = this.state.nos[j];
            }
            var data = [];
            for (j = 0; j < 19; j++) {
                data[j + 1] = t[j];
    ...
    if(this.state.choice == 'incube') {
        console.log(this.state.noi)
        let j = 0;
        let t = [];
        for (j = 0; j < 19; j++) {
            t[j] = this.state.noi[j];
        }
        var data = [];
        for (j = 0; j < 19; j++) {
            data[j + 1] = t[j];
